patterns:
    ...
    $goodbye = * (пока/гудбай/бай/bye/досвид*/до (свид*/завтра/встреч*)/покеда/всего * (добр*/хорош*)) *
    $weather = * ([~какой/что */узнать */расскажи *] * ~прогноз */~погода/~погодка) *
    $yes = * (могу/смогу/верно/да/lf/дада/ok/так точно/ага/угу*/конечно/соглас*/хорошо/давай*) *
    $dontknow = * ([еще/пока] не (выбрал*/решил*/знаю/помню/определил*)/{нет [пока/еще]}/потом [решу]) *
    $no = * (не /не могу/неверно/неправильно/не*(верно/правильно)/иначе/неа/ноу/другой/нет/ytn) *
    $refuse = * (не (назову/скажу/чего/хочу/нужен)/ни (чего/~какой/как)/никак/никакой/уйди/отстань/отвяжись) *
    $tour = * (прими/~оформить/~оформлять/~путевка/~заявка/~заявочка/турагенство/агенство/агентство/турфирма/путешествие/подать) *
